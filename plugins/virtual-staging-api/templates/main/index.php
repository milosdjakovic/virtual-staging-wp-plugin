        ...
        <div class="flex flex-col-reverse gap-4 md:flex-row">
            ...
            <div class="md:w-2/3" id="renderPageResultsContainer">
                <div class="mb-2 flex items-center space-x-4">
                    ...
                    <div class="flex items-center space-x-2" data-testid="render-page-vote-thumbs"><svg
                            stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24"
                            stroke-linecap="round" stroke-linejoin="round"
                            class="transition-colors cursor-pointer hover:text-green-500" height="1em" width="1em"
                            ...
                            stroke-linecap="round" stroke-linejoin="round"
                            class="transition-colors cursor-pointer hover:text-red-500" height="1em" width="1em"
                            xmlns="http://www.w3.org/2000/svg">
