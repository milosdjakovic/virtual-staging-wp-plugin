...
<body>
    <div class="ReactModal__Content ReactModal__Content--after-open z-20 flex h-full max-h-screen w-full justify-center overflow-auto bg-white p-4 pt-12 font-outfit outline-none sm:overflow-hidden md:h-auto md:w-auto md:max-w-[90vw] md:rounded-2xl md:p-6 md:pt-6 md:shadow-sm sm:overflow-visible snipcss-7K6H4"
        tabindex="-1" role="dialog" aria-modal="true"><svg stroke="currentColor" fill="none" stroke-width="2"
            viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round"
            class="absolute right-6 top-4 text-2xl md:hidden" height="1em" width="1em"
        ...
        <div class="hidden style-wTgLQ" id="style-wTgLQ">
            <div>
                ...
                <div class="flex flex-col-reverse items-center justify-center gap-4 md:flex-row md:justify-end"><button
                        class="flex text-sm font-semibold leading-none relative transition-colors duration-75 items-center justify-center gap-1 md:gap-1.5 rounded-xl border-2 px-10 py-3 text-darkgray border-darkgray hover:bg-darkgray hover:text-white w-full"><span>Keep
                            furniture</span></button><button
                        class="flex text-sm font-semibold leading-none relative transition-colors duration-75 items-center justify-center gap-1 md:gap-1.5 rounded-xl border-2 px-10 py-3 text-white bg-primary border-primary hover:bg-primary/90 hover:border-primary/50 w-full"><span>Remove
                            furniture</span></button></div>
            </div>
        </div>
            ...
            <div class="flex w-full flex-col gap-4 h-auto md:grid-cols-[4fr_3fr] lg:grid lg:max-h-[600px]">
                        ...
                        <div class="flex w-full flex-col">
                            <div class="flex h-auto flex-col items-center md:aspect-[7/5]">
                                <div role="presentation" tabindex="0"
                                    ...
                                    <div class="flex items-center gap-2 flex-col text-center"><svg stroke="currentColor"
                                            fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round"
                                            stroke-linejoin="round" class="shrink-0 text-xl" height="1em" width="1em"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path>
                                            <polyline points="17 8 12 3 7 8"></polyline>
                                            <line x1="12" x2="12" y1="3" y2="15"></line>
                                        </svg><span><span class="md:font-medium md:text-primary">Upload an
                                                image</span><span class="hidden md:inline"> or drag and
                                                drop</span></span></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="grid gap-2 sm:grid-cols-3"><button
                            class="flex items-center justify-center gap-2 rounded-xl border border-black/15 p-2 text-center transition-all duration-100 bg-black text-white"><svg
                            ...
                            </svg>Virtual Staging</button><button
                            class="flex items-center justify-center gap-2 rounded-xl border border-black/15 p-2 text-center transition-all duration-100 text-black/90 hover:bg-black/10 break-all"><svg
                            ...
                            </svg>Enhancement</button><button
                            class="flex items-center justify-center gap-2 rounded-xl border border-black/15 p-2 text-center transition-all duration-100 text-black/90 hover:bg-black/10"><svg
                    ...
                    <div class="flex flex-col gap-2">
                        <div
                            ...
                            <div class="flex items-center gap-2"><svg stroke="currentColor" fill="none" stroke-width="2"
                                ...
                                <div sx="[object Object]" class=""><svg stroke="currentColor" fill="none"
                                        stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round"
                                        stroke-linejoin="round" class="text-base opacity-50" height="1em" width="1em"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="12" cy="12" r="10"></circle>
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-2"><svg stroke="currentColor" fill="none" stroke-width="2"
                                ...
                                <div class="whitespace-nowrap text-base">Add furniture</div><input
                                    class="ml-auto h-5 w-5 rounded border-gray-300 bg-white text-primary focus:ring-2"
                                    readonly="" type="checkbox">
                            </div>
                                        ...
                                        <div
                                            ...
                                            <label for=":rb5:" id=":rb5:-label" class="MuiFormLabel-root css-rtxwyt">
                                                <div class="flex items-center">
                                                    <div class="mr-2 inline-block"><svg stroke="currentColor"
                                            ...
                                            <div
                                                ...
                                                <button role="combobox" aria-expanded="false" aria-controls=":rb6:"
                                                    ...
                                                    class="MuiSelect-button css-1qmzz5g"
                                                    type="button">Bedroom</button><span
                                                    class="MuiSelect-indicator css-nvn28y"><svg focusable="false"
                                                        aria-hidden="true" viewBox="0 0 24 24" data-testid="UnfoldIcon"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <button role="combobox" aria-expanded="false" aria-controls=":rb8:"
                                                    ...
                                                    class="MuiSelect-button css-1qmzz5g"
                                                    type="button">Standard</button><span
                                                    class="MuiSelect-indicator css-nvn28y"><svg focusable="false"
                                                        aria-hidden="true" viewBox="0 0 24 24" data-testid="UnfoldIcon"
                                                        class="MuiSvgIcon-root MuiSvgIcon-sizeMd css-c9nsto">
                                                        <path
                                                    ...
                                                    </svg></span><input tabindex="-1" aria-hidden="true"
                                                    value="standard" name="radio-buttons-group" id="style-P8iXl"
                                                    class="style-P8iXl">
                                            </div>
                                        </div>
                                    </div>
                        ...
                        disabled=""><span>Process photo</span></button>
                </div>
            </div>
        </div>
    </div>
